...
void Sub_717B()
{
    ...
    if (Sub_7254(b5112[bC266] >> 6, wC269)) {
        ...
        if (Sub_7254((b5112[bC266] >> 3) & 7, wC26D)) {
            ...
            if (bC272 == 0 && bC273 == 8)
                p = p & 0xFF;
            m2_setNumOrIdn(p, curInfoP, bC272, bC273);
            curOpFlags = flagsT2[curOp = tx2opc[tx2qp]];
        }
    }
}
...
static void Sub_7754()
{
    ...
    i = tx2qp + 1;
    while (tx2opc[i] == T2_OPTBACKREF && i < tx2lastPos)
        i = i + 1;
    j = tx2qp;
